...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.dateEdit_3, 6, 1, 1, 1)
        ...
        self.dateEdit_2 = QDateEdit(self.gridLayoutWidget)
        ...
        self.gridLayout.addWidget(self.dateEdit_4, 7, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.tableView, 9, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.findPushButton, 8, 1, 1, 1)
